...
BEGIN
	...
	DECLARE @TenantLanguage2 NVARCHAR (255) =  (SELECT [TenantLanguage2] FROM dbo.Settings)
	DECLARE @TenantLanguage3 NVARCHAR (255) =  (SELECT [TenantLanguage3] FROM dbo.Settings)
	RETURN CASE 
